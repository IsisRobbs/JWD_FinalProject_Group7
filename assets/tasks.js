class Task {
  ...
  const createTaskHtml = (taskName, taskDescription, firstName, lastName, dueDate, progress, id) => {
    ...
    <img class="card-img-top width-30 height-30" id="result">
...
class TaskManager {
  ...
  pictureGenerater(){
    ...
    randomImage[0] = "./images/aesthetic-card1.jpg";
    randomImage[1] = "./images/aesthetic-card2.jpg";
    randomImage[2] = "./images/aesthetic-card3.jpg";
    randomImage[3] = "./images/aesthetic-card4.jpg";
    randomImage[4] = "./images/aesthetic-card5.jpg";
    randomImage[5] = "./images/aesthetic-card6.jpg";
